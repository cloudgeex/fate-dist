(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@angular/material/form-field'), require('rxjs'), require('@angular/platform-browser'), require('@angular/cdk/coercion')) :
    typeof define === 'function' && define.amd ? define('fate-editor', ['exports', '@angular/core', '@angular/common', '@angular/forms', '@angular/material/form-field', 'rxjs', '@angular/platform-browser', '@angular/cdk/coercion'], factory) :
    (global = global || self, factory(global['fate-editor'] = {}, global.ng.core, global.ng.common, global.ng.forms, global.ng.material.formField, global.rxjs, global.ng.platformBrowser, global.ng.cdk.coercion));
}(this, (function (exports, core, common, forms, formField, rxjs, platformBrowser, coercion) { 'use strict';
